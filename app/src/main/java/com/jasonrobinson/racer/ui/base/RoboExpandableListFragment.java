...
public class RoboExpandableListFragment extends RoboFragment implements OnCreateContextMenuListener, ExpandableListView.OnChildClickListener, ExpandableListView.OnGroupCollapseListener, ExpandableListView.OnGroupExpandListener, OnGroupClickListener {
    ...
    private void setListShown(boolean shown, boolean animate) {
        ...
        if (shown) {
            if (animate) {
                ...
                mExpandableListContainer.startAnimation(AnimationUtils.loadAnimation(getActivity(), android.R.anim.fade_in));
            } else {
            ...
            if (animate) {
                ...
                mExpandableListContainer.startAnimation(AnimationUtils.loadAnimation(getActivity(), android.R.anim.fade_out));
            } else {
                mProgressContainer.clearAnimation();
                mExpandableListContainer.clearAnimation();
            }
     ...
     * @param shouldExpandGroup Whether the child's group should be expanded if it is
     *                          collapsed.
